...
- [`docs/DEPLOYMENT.md`](docs/DEPLOYMENT.md) - low-cost website deployment plan

## Status

M0 foundation started: Next.js, TypeScript, Prisma, Tailwind, seed data, and private-site
