...
export function AddGuestForm() {
  return <form action={addGuest} className="grid gap-4">
    ...
    <div className="grid grid-cols-2 gap-3"><Field label="Side"><select className={inputClass} name="side"><option value="aayush_groom">Aayush</option><option value="grace_bride">Grace</option><option value="both">Shared</option></select></Field><Field label="Guest type"><select className={inputClass} name="ageBand"><option value="adult">Adult</option><option value="child">Child</option><option value="infant">Infant</option></select></Field></div>
    <div className="grid grid-cols-2 gap-3"><Field label="Age"><input className={inputClass} min="0" name="age" type="number" /></Field><Field label="Gender"><select className={inputClass} name="gender"><option value="">Not specified</option><option value="female">Female</option><option value="male">Male</option><option value="non_binary">Non-binary</option><option value="other">Other</option></select></Field></div>
...
export function AddFamilyForm() {
  ...
  return <form action={addFamily} className="grid gap-5">
    ...
    {members.map((id, index) => <section className="rounded-2xl border border-line bg-white p-4" key={id}>
      ...
      <div className="grid gap-3 sm:grid-cols-2"><Field label="First name"><input className={inputClass} name="firstName" required /></Field><Field label="Last name"><input className={inputClass} name="lastName" required /></Field><Field label="Age"><input className={inputClass} min="0" name="age" type="number" /></Field><Field label="Gender"><select className={inputClass} name="gender"><option value="">Not specified</option><option value="female">Female</option><option value="male">Male</option><option value="non_binary">Non-binary</option><option value="other">Other</option></select></Field><Field label="Side"><select className={inputClass} name="side"><option value="aayush_groom">Aayush</option><option value="grace_bride">Grace</option><option value="both">Shared</option></select></Field><Field label="Guest type"><select className={inputClass} name="ageBand"><option value="adult">Adult</option><option value="child">Child</option><option value="infant">Infant</option></select></Field><Field label="RSVP"><select className={inputClass} name="rsvpStatus">{rsvpOptions}</select></Field><Field label="Meal"><select className={inputClass} name="mealChoice">{mealOptions}</select></Field></div>
